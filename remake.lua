...
local redzlib = {
	Themes = {
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 15, 50)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 25, 60)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 15, 50))
			}),
			["Color Hub 2"] = Color3.fromRGB(65, 30, 115),
			["Color Stroke"] = Color3.fromRGB(40, 40, 40),
			["Color Theme"] = Color3.fromRGB(50, 25, 90),
			["Color Text"] = Color3.fromRGB(240, 240, 240),
			["Color Dark Text"] = Color3.fromRGB(180, 180, 180),
			["Color Dark Purple"] = Color3.fromRGB(175, 0, 255),
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Close",
			Text = "Deseja realmente fechar o Lxnny Client? Ele contém recursos essenciais e fechar agora pode interromper funções importantes, causar falhas ou perder suas configurações. Cuidado antes de prosseguir!",
			Options = {
				{"Yes", function()
					ScreenGui:Destroy()
				end},
